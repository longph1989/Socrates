...
(time python -u source/run_refinement.py --spec benchmark/eran/nnet/mnist_relu_4_1024/spec.json --algorithm refinement --has_ref --max_ref 100 --dataset mnist_fc --num_tests 10) &> results_refinement/log_mnist_relu_4_1024.tf.txt
