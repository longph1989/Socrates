...
# (time python -u source/run_refinement.py --spec benchmark/cegar/nnet/mnist_relu_5_50/spec.json --algorithm refinement --has_ref --max_ref 100 --dataset mnist_fc --num_tests 1) &> results_refinement/log_mnist_relu_5_50.tf.txt
...
# (time python -u source/run_refinement.py --spec benchmark/eran/nnet/mnist_relu_4_1024/spec.json --algorithm refinement --has_ref --max_ref 100 --dataset mnist_fc --num_tests 1) &> results_refinement/log_mnist_relu_4_1024.tf.txt
# echo Running mnist_relu_6_100.tf
# (time python -u source/run_refinement.py --spec benchmark/eran/nnet/mnist_relu_6_100/spec.json --algorithm refinement --has_ref --max_ref 100 --dataset mnist_fc) &> results_refinement/log_mnist_relu_6_100.tf.txt
# echo Running mnist_relu_9_200.tf
# (time python -u source/run_refinement.py --spec benchmark/eran/nnet/mnist_relu_9_200/spec.json --algorithm refinement --has_ref --max_ref 100 --dataset mnist_fc) &> results_refinement/log_mnist_relu_9_200.tf.txt
echo Done!
