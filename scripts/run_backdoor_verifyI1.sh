...
(time python -u source/run_backdoor.py --spec benchmark/eran/nnet/mnist_relu_4_1024/spec.json --algorithm backdoor --total_imgs 100 --rate 1.0 --dataset mnist_fc --num_procs 5) &> results_backdoor_verifyI1/log_mnist_relu_4_1024.tf.txt
echo Running mnist_relu_6_100.tf
(time python -u source/run_backdoor.py --spec benchmark/eran/nnet/mnist_relu_6_100/spec.json --algorithm backdoor --total_imgs 100 --rate 1.0 --dataset mnist_fc) &> results_backdoor_verifyI1/log_mnist_relu_6_100.tf.txt
echo Running mnist_relu_9_200.tf
(time python -u source/run_backdoor.py --spec benchmark/eran/nnet/mnist_relu_9_200/spec.json --algorithm backdoor --total_imgs 100 --rate 1.0 --dataset mnist_fc) &> results_backdoor_verifyI1/log_mnist_relu_9_200.tf.txt

echo Running mnist_conv_small_relu.tf
(time python -u source/run_backdoor.py --spec benchmark/backdoor/eran/nnet/mnist_conv_small_relu/spec.json --algorithm backdoor --total_imgs 100 --rate 1.0 --dataset mnist_conv) &> results_backdoor_verifyI1/log_mnist_conv_small_relu.tf.txt
echo Running mnist_conv_small_relu_diffai.tf
(time python -u source/run_backdoor.py --spec benchmark/backdoor/eran/nnet/mnist_conv_small_relu_diffai/spec.json --algorithm backdoor --total_imgs 100 --rate 1.0 --dataset mnist_conv) &> results_backdoor_verifyI1/log_mnist_conv_small_relu_diffai.tf.txt
