...
(time python -u source/run_backdoor_repair.py --spec benchmark/backdoor/bd_nnet/bd_mnist_relu_3_10/spec.json --algorithm backdoor_repair --known_stamp --stamp_pos 725 --dataset mnist_fc --target 3) &> results_backdoor_repair/log_bd_mnist_relu_3_10.tf.txt
# echo Running mnist_relu_3_20.tf
# (time python -u source/run_backdoor_repair.py --spec benchmark/backdoor/bd_nnet/bd_mnist_relu_3_20/spec.json --algorithm backdoor_repair --known_stamp --stamp_pos 25 --dataset mnist_fc --target 2) &> results_backdoor_repair/log_bd_mnist_relu_3_20.tf.txt
# echo Running mnist_relu_3_30.tf
# (time python -u source/run_backdoor_repair.py --spec benchmark/backdoor/bd_nnet/bd_mnist_relu_3_30/spec.json --algorithm backdoor_repair --known_stamp --stamp_pos 25 --dataset mnist_fc --target 6) &> results_backdoor_repair/log_bd_mnist_relu_3_30.tf.txt
# echo Running mnist_relu_3_40.tf
# (time python -u source/run_backdoor_repair.py --spec benchmark/backdoor/bd_nnet/bd_mnist_relu_3_40/spec.json --algorithm backdoor_repair --known_stamp --stamp_pos 725 --dataset mnist_fc --target 9) &> results_backdoor_repair/log_bd_mnist_relu_3_40.tf.txt
# echo Running mnist_relu_3_50.tf
# (time python -u source/run_backdoor_repair.py --spec benchmark/backdoor/bd_nnet/bd_mnist_relu_3_50/spec.json --algorithm backdoor_repair --known_stamp --stamp_pos 0 --dataset mnist_fc --target 0) &> results_backdoor_repair/log_bd_mnist_relu_3_50.tf.txt
