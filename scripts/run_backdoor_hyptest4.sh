...
(timeout 120m time python -u source/run_backdoor.py --spec benchmark/cegar/nnet/mnist_relu_5_50/spec.json --algorithm backdoor --num_imgs 10 --rate 0.8 --dataset mnist_fc) &> results_backdoor_hyptest4/log_mnist_relu_5_50.tf.txt
...
(timeout 120m time python -u source/run_backdoor.py --spec benchmark/cegar/nnet/mnist_sigmoid_5_50/spec.json --algorithm backdoor --num_imgs 10 --rate 0.8 --dataset mnist_fc) &> results_backdoor_hyptest4/log_mnist_sigmoid_5_50.tf.txt
...
(timeout 120m time python -u source/run_backdoor.py --spec benchmark/cegar/nnet/mnist_tanh_5_50/spec.json --algorithm backdoor --num_imgs 10 --rate 0.8 --dataset mnist_fc) &> results_backdoor_hyptest4/log_mnist_tanh_5_50.tf.txt
